...
public class SysLoginService
{
    ...
    public String login(String username, String password, String code, String uuid)
    {
        ...
        //设置用户数据权限
        loginUser.setAllDataAccess(dataAccessUtils.isAllDataAccess(loginUser)+"");
        loginUser.setDataAccessList(dataAccessUtils.getCurrUserDataAccessDeptToList(loginUser));
        // 生成token
