...
import com.isstech.isstechadmin.domain.dto.EventAnalysisDTO;
 ...
 * @date 2021-03-30
 */
public interface BaseEventInfoDataMapper {
    /**
     * 获取uuid
     */
    ...
    @Select("select event_status name,count(event_status) num from base_event_info GROUP BY event_status ")
    public List<GroupByVo> countEvent();

    public void batchSave(List<BaseEventInfo> list);

    public void deleteAll();

    public EventAnalysisDTO analysisData();
