 ...
 * @Description 用户信息
 * @Author yzp
 * @Date 2020/11/10 19:16
 */
@Api(tags ="SysUser", description = "用户信息管理")
@RestController
...
//        }
    ...
    @Log(title = "用户管理", businessType = BusinessType.DELETE)
    @PutMapping("/{userIds}")
    public AjaxResult update(@PathVariable String[] userIds)
    {
        return toAjax(userService.updateUserByIds(userIds));
    }
