package com.isstech.security.websocket.utils;
...
public class TimeUtil {
    ...
    /**
     * 根据格式获取当前时间
     * @param pattern exp : "HH:mm:ss"  yyyy-MM-dd HH:mm:ss
     * @return
     */
    ...
    public static Date plusDay(int num, String newDate) throws ParseException{
        ...
        ca.setTime(currdate);
        ca.add(Calendar.MINUTE, num); // 加分钟
//        String enddate = format.format(currdate);
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(TimeUtil.getByPattern("yyyy-MM-dd HH:mm:ss"));
//        System.out.println(TimeUtil.getByPattern("yyyy-MM-dd"));
//        System.out.println(TimeUtil.plusDay( 30, TimeUtil.getByPattern("yyyy-MM-dd") + " 9:00:33"));
    }
}
