...
import com.isstech.isstechadmin.domain.vo.RouterVo;
...
import com.isstech.common.core.domain.TreeSelect;
import com.isstech.common.utils.SecurityUtils;
import com.isstech.common.utils.StringUtils;
import com.isstech.isstechadmin.domain.vo.MetaVo;
import com.isstech.isstechadmin.mapper.SysMenuMapper;
import com.isstech.isstechadmin.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<String> selectMenuListByAdmin() {
        return menuMapper.selectMenuListByAdmin();
    }
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        if (menus != null && !menus.isEmpty()) {
            for (SysMenu menu : menus) {
                ...
                router.setMultiComponent(menu.getMultiComponent());
  ...
  /*  public List<RouterVo> buildMenus1(List<SysMenu> menus) {
        ...
        if (menus != null && !menus.isEmpty()) {
            for (SysMenu menu : menus) {
                ...
                children.setMultiComponent(menu.getMultiComponent());
     ...
     */
    @Override
    public int updateMenuById(String menuId) {
        return menuMapper.updateMenuById(menuId);
    }
    ...
    public String checkMenuNameUnique(SysMenu menu) {
        ...
        SysMenu info = menuMapper.checkMenuNameUnique(menu.getName(), menu.getParentId());
        if (StringUtils.isNotNull(info) && menuId.equals(info.getId())) {
    ...
    public String getRouterPath(SysMenu menu) {
        ...
        // 非外链并且是一级目录（类型为目录）
        if ("0".equals(menu.getParentId()) && UserConstants.TYPE_DIR.equals(menu.getType())
    ...
    public boolean isMeunFrame(SysMenu menu) {
        return "0".equals(menu.getParentId()) && UserConstants.TYPE_MENU.equals(menu.getType())
