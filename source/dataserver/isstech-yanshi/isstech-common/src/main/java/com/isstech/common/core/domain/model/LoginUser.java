package com.isstech.common.core.domain.model;
...
public class LoginUser implements UserDetails
{
    ...
    private String isAllDataAccess;
    ...
    public String isAllDataAccess() {
        return isAllDataAccess;
    }

    public void setAllDataAccess(String allDataAccess) {
