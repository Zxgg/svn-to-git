...
import com.isstech.framework.web.service.SysPermissionService;
...
//        }
        ...
        return AjaxResult.error("修改角色'" + role.getName() + "'失败，请联系管理员");
    }
    ...
    @Log(title = "角色管理", businessType = BusinessType.DELETE)
    @PutMapping("/{roleIds}")
    public AjaxResult update(@PathVariable String[] roleIds)
    {
        return toAjax(roleService.updateRoleByIds(roleIds));
    }
