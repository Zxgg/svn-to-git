  ...
  <div class="right_content"
    ...
    <el-table v-show="tabflag===1"
      ...
      <el-table-column prop="eventName"
                       ...
                       width="150">
        <template slot-scope="scope">
          <span :title="'事件名称：' + scope.row.eventName">{{scope.row.eventName| ellipsis}}</span>
        </template>
      </el-table-column>
      </el-table-column>
      <!-- <el-table-column prop="eventName"
      ...
      <el-table-column prop="dealWithType"
                       label="事件来源"
                       width="90">
        <template slot-scope="scope">
          <span :title="'事件名称：' + scope.row.eventName">{{scope.row.dealWithType}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="division"
                       ...
                       width="80">
        <template slot-scope="scope">
          <span :title="'事件名称：' + scope.row.eventName">{{scope.row.division}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="eventStatus"
                       label="处置状态">
        <template slot-scope="scope">

          <span v-show="scope.row.eventStatus==='1'"
                class="bg bg2">已受理</span>
          <span v-show="scope.row.eventStatus==='2'"
                class="bg bg1">已分派</span>
          <span v-show="scope.row.eventStatus==='3'"
                class="bg bg3">已办结</span>
          <span v-show="scope.row.eventStatus==='4'"
                class="bg bg3">已归档</span>
        </template>
      </el-table-column>
    </el-table>
    <el-table v-show="tabflag===2"
              :data="tab2"
              empty-text="加载中"
              style="width: 100%"
              :header-cell-style="{
    ...
    <el-dialog class="motai"
            ...
            <div class="info-form">
              ...
              <el-form :model="zibanjieform"
                ...
                <div class="motai_box">
                  <el-form-item class=""
                                label="行政区划:">
                    <div class="formcontent">{{ zibanjieform.division || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item class=""
                                label="处置类型:">
                    <div class="formcontent">{{ zibanjieform.dealWithType || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item class=""
                                label="事件编号:">
                    <div class="formcontent">{{ zibanjieform.id || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item class=""
                                label="事件标题:">
                    <div class="formcontent">{{ zibanjieform.eventName || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item label="事件来源:">
                    <div class="formcontent">{{ zibanjieform.dealWithType ==='1' ?  "智能化上报":"人工上报"|| "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item label="事件类型:">
                    <div class="formcontent">{{ zibanjieform.eventType || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item label="上报人:">
                    <div class="formcontent">{{ zibanjieform.handleBy || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item label="上报时间:">
                    <div class="formcontent">{{ zibanjieform.reportingTime || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item label="诉求人姓名:">
                    <div class="formcontent"> 暂无</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
     ...
     <el-form-item label="状态:">
                ...
                <div class="motai_box motai_box_long"
                  ...
                  <el-form-item class=""
                                label="严重程度:">
                    <div class="formcontent">{{ zibanjieform.eventDegree==="1"? "一般":"严重" || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item label="检查对象:">
                    <div class="formcontent">{{ zibanjieform.updataBy || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item label="检查类别:">
                    <div class="formcontent">{{ zibanjieform.checkType || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box motai_box_long">
                  <el-form-item label="内容:">
                    <div class="formcontent">{{ zibanjieform.content || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box motai_box_long">
                  <el-form-item label="备注:">
                    <div class="formcontent">{{ zibanjieform.remarks || "暂无" }}</div>
                  </el-form-item>
                </div>
              </el-form>
            </div>
        ...
        <div class="motai_bottom">
          ...
          <div class="liuchengfather">
            <div v-for="(item, i) in liuchengList"
                 :key="item.id"
                 class="liucheng">
              <div class="liucheng_first">
                <div><img src="../../../assets/images/events/gouxuan.png"
                       alt=""></div>
                <div v-show="i<4"><img src="../../../assets/images/events/jiantou.png"
                       alt=""></div>
             ...
             <div v-show="(1-liuchengList.length)> 0"
                 class="liucheng ">
              <div class="liucheng_first">
                <div><img src="../../../assets/images/events/gouxuan.png"
                       alt=""
                       v-show="false"></div>
                <div><img src="../../../assets/images/events/jiantou.png"
                       alt=""></div>

              </div>
              <div class="liucheng_two">上报</div>
            </div>
            <div v-show="(2-liuchengList.length)> 0"
                 class="liucheng ">
              <div class="liucheng_first">
                <div><img src="../../../assets/images/events/gouxuan.png"
                       alt=""
            ...
            <div v-show="(3-liuchengList.length)> 0"
                 class="liucheng ">
              <div class="liucheng_first">
                <div><img src="../../../assets/images/events/gouxuan.png"
                       alt=""
            ...
            <div v-show="(4-liuchengList.length)> 0"
                 class="liucheng ">
              <div class="liucheng_first">
                <div><img src="../../../assets/images/events/gouxuan.png"
                       alt=""
            ...
            <div v-show="(5-liuchengList.length)> 0"
                 class="liucheng ">
              <div class="liucheng_first">
                <div><img src="../../../assets/images/events/gouxuan.png"
                       alt=""
    ...
    <el-dialog class="motai"
      ...
      <div class="motai_father">
            ...
            <div class="info-form">
              <el-form :model="jieform"
                ...
                <div class="motai_box">
                  <el-form-item class=""
                                label="行政区划:">
                    <div class="formcontent">{{ jieform.division || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item class=""
                                label="处置类型:">
                    <div class="formcontent">{{ jieform.disposition || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item class=""
                ...
                <div class="motai_box">
                  <el-form-item class=""
                                label="事件标题:">
                    <div class="formcontent">{{ jieform.eventName || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item class=""
                                label="事件来源:">
                    <div class="formcontent">{{ jieform.dealWithType || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item class=""
                                label="事件类型:">
                    <div class="formcontent">{{ jieform.eventType || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item class=""
                                label="上报人:">
                    <div class="formcontent">{{ jieform.handleBy || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item class=""
                                label="上报时间:">
                    <div class="formcontent">{{ jieform.reportingTime || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item class=""
                                label="诉求人姓名:">
                    <div class="formcontent">{{ jieform.petitioner || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item label="诉求人电话:">
                    <div class="formcontent">{{ jieform.createByPhone || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box motai_box_long"
                     style="height:25px">
                  <el-form-item class=""
                                label="严重程度:">
                    <div class="formcontent">{{ jieform.eventDegree || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item label="检查对象:">
                    <div class="formcontent">{{ jieform.updataBy || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box">
                  <el-form-item label="检查类别:">
                    <div class="formcontent">{{ jieform.checkType || "暂无" }}</div>
                  </el-form-item>
                </div>
                <div class="motai_box motai_box_long">
                  <el-form-item class=""
                ...
                <div class="motai_box motai_box_long">
                  <el-form-item class=""
                                label="备注:">
                    <div class="formcontent">{{ jieform.remark || "暂无" }}</div>
                  </el-form-item>
                </div>
        ...
        <div class="matai_bottom">
          ...
          <div class="liuchengfather">
            <div v-for="(itm, i) in jieform.remarks"
                 :key="i"
                 class="liucheng">
              <div class="liucheng_first">
                <div><img src="../../../assets/images/events/gouxuan.png"
                       alt=""></div>
                <div v-show="jieform.remarks.length !==(i+1)"><img src="../../../assets/images/events/jiantou.png"
                       alt=""></div>
...
import {
  baseshijianEventInfoList, ajaxFuntion,
  getCommunity_event, getInfo, listRecord, getshangbao,newGetEventData
  ...
  methods: {
    ...
    handle (row) {
     ...
     if (row.bigPicture) {
            if (row.bigPicture.indexOf(configInfo.imgEchoAddress) === -1) {
             this.zibanjieform.bigPicture = configInfo.imgEchoAddress + row.bigPicture;
            }
          }
      if (row.alertFile.indexOf(configInfo.imgEchoAddress) === -1) {
        this.zibanjieform.alertFile = configInfo.imgEchoAddress + row.alertFile;
      }
      this.handleInfo()
    ...
    liuchengchuli () {
      this.liuchengList = this.liuchengList.filter((val, index) => {
        return val.eventStatusSon !== "2" && val.eventStatusSon !== "4" && val.eventStatusSon !== "6"
      })
