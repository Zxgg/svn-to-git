      ...
      <el-scrollbar class="left-scrollbar">
        <div class="components-list">
          ...
          <draggable class="components-draggable"
                     ...
                     :sort="false"
                     @end="onEnd">
            <div v-for="(element, index) in inputComponents"
                 :key="index"
          ...
          <draggable class="components-draggable"
                     ...
                     :sort="false"
                     @end="onEnd">
            <div v-for="(element, index) in selectComponents"
                 :key="index"
                 class="components-item"
                 @click="addComponent(element)">
              <div class="components-body">
          ...
          <draggable class="components-draggable"
                     ...
                     :sort="false"
                     @end="onEnd">
            <div v-for="(element, index) in layoutComponents"
                 :key="index"
                 class="components-item"
                 @click="addComponent(element)">
              <div class="components-body">
