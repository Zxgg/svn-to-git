  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['communityManage:org_public:add']"
          >新增</el-button
        >
        <el-button
          type="danger"
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['communityManage:org_public:remove']"
          >删除</el-button
        >
    ...
    >
      ...
      <el-table-column
        ...
        prop="directionDep"
      />
      <el-table-column label="人员数量" align="center" prop="peopleCount" />
      <el-table-column label="序号" align="center" prop="sort" />
      <el-table-column label="主要职能" align="center" prop="res" />
      <el-table-column label="行政区划" align="center" prop="division" />
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['communityManage:org_public:edit']"
            >修改</el-button
          >
          <el-button
            size="mini"
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="组织层级" prop="orgLevel">
              <el-select v-model="form.orgLevel" placeholder="请选择组织层级">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="业务指导部门" prop="directionDep">
              <el-input
                v-model="form.directionDep"
                placeholder="请输入业务指导部门"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="人员数量" prop="peopleCount">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="行政区划" prop="division">
              <el-input v-model="form.division" placeholder="请输入行政区划" />
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  created() {
    ...
    this.getList();
    this.getDicts("base_mass_prevention_control_organization").then(
      response => {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getOrg_public(id).then(response => {
        ...
        //  先不用社区id
        this.getCommunityChildDictory2();
        this.getHouseByID();
