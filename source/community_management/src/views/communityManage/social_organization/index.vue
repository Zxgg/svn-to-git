    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['communityManage:social_organization:add']"
          >新增</el-button
        >
        <el-button
          type="danger"
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['communityManage:social_organization:remove']"
          >删除</el-button
        >
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span>{{
            parseTime(scope.row.dateOfEstablishment, "{y}-{m}-{d}")
          }}</span>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['communityManage:social_organization:edit']"
            >修改</el-button
          >
          <el-button
            size="mini"
    ...
    <el-dialog :title="title" :visible.sync="open" width="1200px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="240px">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="负责人姓名" prop="nameOfPersonInCharge">
              <el-input
          ...
          <el-col :span="12">
            ...
            >
              <el-input
                v-model="form.identificationNumberOfPersonInCharge"
                placeholder="请输入负责人身份证(18位身份证号码)"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="负责人性别" prop="sexOfPersonInCharge">
              <el-select
                v-model="form.sexOfPersonInCharge"
                placeholder="请选择负责人性别"
              >
                <el-option
                  v-for="dict in sexOfPersonInChargeOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                ></el-option>
          ...
          <el-col :span="12">
            ...
            >
              <el-input
                v-model="form.phonenumOfPersonInCharge"
                placeholder="请输入负责人联系方式"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="负责人联系地址" prop="addressOfPersonInCharge">
              <el-input
                v-model="form.addressOfPersonInCharge"
                type="textarea"
                placeholder="请输入内容"
              />
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item label="治安负责人姓名" prop="securityResponsibleName">
              <el-input
                v-model="form.securityResponsibleName"
                placeholder="请输入治安负责人姓名"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            ...
            >
              <el-input
                v-model="form.securityResponsiblePhone"
                placeholder="请输入治安负责人联系方式"
              />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="有境外背景关系" prop="haveForeignRelationship">
              <el-select
                v-model="form.haveForeignRelationship"
                placeholder="请选择有境外背景关系"
              >
                <el-option
                  v-for="dict in haveForeignRelationshipOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                ></el-option>
          ...
          <el-col :span="12">
            <el-form-item label="社会组织类型" prop="socialOrganizationType">
              <el-select
                v-model="form.socialOrganizationType"
                placeholder="请选择社会组织类型"
              >
                <el-option
                  v-for="dict in socialOrganizationTypeOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                ></el-option>
          ...
          <el-col :span="12">
            <el-form-item label="关注程度" prop="caringLevel">
              <el-select
                v-model="form.caringLevel"
                placeholder="请选择关注程度"
              >
                <el-option
                  v-for="dict in caringLevelOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
          ...
          <el-col :span="12">
            <el-form-item
              label="是否具备条件建立中国共产党支部"
              prop="canCreateChineseCommunistPartyBranch"
            >
              <el-select
                v-model="form.canCreateChineseCommunistPartyBranch"
                placeholder="请选择是否具备条件建立中国共产党支部"
              >
                <el-option
                  v-for="dict in canCreateChineseCommunistPartyBranchOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                ></el-option>
          ...
          <el-col :span="12">
            ...
            >
              <el-select
                v-model="form.haveChineseCommunistPartyBranch"
                placeholder="请选择是否有中国共产党支部"
              >
                <el-option
                  v-for="dict in haveChineseCommunistPartyBranchOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                ></el-option>
          ...
          <el-col :span="12">
            ...
            >
              <el-input
                v-model="form.chineseCommunistPartyBranchPeopleNum"
                placeholder="请输入共产党支部人员数量"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否有公会" prop="haveUnion">
              <el-select
                v-model="form.haveUnion"
                placeholder="请选择是否有公会"
              >
                <el-option
                  v-for="dict in haveUnionOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                ></el-option>
          ...
          <el-col :span="12">
            <el-form-item label="公会人数" prop="unionPeopleNum">
              <el-input
                v-model="form.unionPeopleNum"
                placeholder="请输入公会人数"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否有共青团" prop="haveCommunistYouthLeague">
              <el-select
                v-model="form.haveCommunistYouthLeague"
                placeholder="请选择是否有共青团"
              >
                <el-option
                  v-for="dict in haveCommunistYouthLeagueOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                ></el-option>
          ...
          <el-col :span="12">
            ...
            >
              <el-input
                v-model="form.communistYouthLeaguePeopleNum"
                placeholder="请输入共青团员数量"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否有妇联组织" prop="haveWomenSFederation">
              <el-select
                v-model="form.haveWomenSFederation"
                placeholder="请选择是否有妇联组织"
              >
                <el-option
                  v-for="dict in haveWomenSFederationOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                ></el-option>
          ...
          <el-col :span="12">
            ...
            >
              <el-input
                v-model="form.womenSFederationPeopleNum"
                placeholder="请输入妇联组织成员人数"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="资金来源信息" prop="sourcesOfFunds">
              <el-input
                v-model="form.sourcesOfFunds"
                type="textarea"
                placeholder="请输入内容"
              />
            </el-form-item>
...
<script>
import {
  listSocial_organization,
  getSocial_organization,
  delSocial_organization,
  addSocial_organization,
  updateSocial_organization,
  exportSocial_organization
} from "@/api/communityManage/social_organization";
import {
  ...
  methods: {
    ...
    sexOfPersonInChargeFormat(row, column) {
      return this.selectDictLabel(
        this.sexOfPersonInChargeOptions,
        row.sexOfPersonInCharge
      );
    },
    // 状态字典翻译
    ...
    socialOrganizationTypeFormat(row, column) {
      return this.selectDictLabel(
        this.socialOrganizationTypeOptions,
        row.socialOrganizationType
      );
    },
    // 有境外背景关系(0为没有1为有，默认0)字典翻译
    haveForeignRelationshipFormat(row, column) {
      return this.selectDictLabel(
        this.haveForeignRelationshipOptions,
        row.haveForeignRelationship
      );
    },
    // 关注程度字典翻译
    ...
    canCreateChineseCommunistPartyBranchFormat(row, column) {
      return this.selectDictLabel(
        this.canCreateChineseCommunistPartyBranchOptions,
        row.canCreateChineseCommunistPartyBranch
      );
    },
    // 是否有中国共产党支部,(0否1是,默认0)字典翻译
    haveChineseCommunistPartyBranchFormat(row, column) {
      return this.selectDictLabel(
        this.haveChineseCommunistPartyBranchOptions,
        row.haveChineseCommunistPartyBranch
      );
    },
    // 是否有公会,(0否1是,默认0)字典翻译
    ...
    haveCommunistYouthLeagueFormat(row, column) {
      return this.selectDictLabel(
        this.haveCommunistYouthLeagueOptions,
        row.haveCommunistYouthLeague
      );
    },
    // 是否有妇联组织,(0否1是,默认0)字典翻译
    haveWomenSFederationFormat(row, column) {
      return this.selectDictLabel(
        this.haveWomenSFederationOptions,
        row.haveWomenSFederation
      );
    },
    // 取消按钮
    cancel() {
