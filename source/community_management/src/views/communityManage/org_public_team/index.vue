    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['communityManage:org_public_team:add']"
          >新增</el-button
        >
        <el-button
          type="danger"
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['communityManage:org_public_team:remove']"
          >删除</el-button
        >
      </el-form-item>
    </el-form>
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['communityManage:org_public_team:edit']"
            >修改</el-button
          >
          <el-button
            size="mini"
    ...
    <el-dialog :title="title" :visible.sync="open" width="1200px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="220px">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="证件代码" prop="idType">
              <el-select v-model="form.idType" placeholder="请选择证件代码">
                <el-option
                  v-for="dict in idTypeOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
          ...
          <el-col :span="12">
            <el-form-item label="固定号码" prop="tel">
              <el-input v-model="form.tel" placeholder="请输入固定号码" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
import {
  ...
  delOrg_public_team,
  addOrg_public_team,
  updateOrg_public_team,
  exportOrg_public_team
} from "@/api/communityManage/org_public_team";
import {
  listOrg_public,
  getOrg_public
} from "@/api/communityManage/org_public";
