<template>
          ...
          <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
              <el-button
                ...
                v-hasPermi="['communityUnit:community:add']"
                >新增</el-button
              >
            </el-col>
            <el-col :span="1.5">
              <el-button
                ...
                v-hasPermi="['communityUnit:community:edit']"
                >修改</el-button
              >
            </el-col>
            <el-col :span="1.5">
              <el-button
                ...
                v-hasPermi="['communityUnit:community:remove']"
                >删除</el-button
              >
            </el-col>
          </el-row>
        ...
        >
          ...
          <el-form-item>
            ...
            <el-button
              ...
              size="mini"
              @click="handleAdd"
              v-hasPermi="['communityUnit:community_child:add']"
              >新增</el-button
            >
            <el-button
              type="danger"
              ...
              :disabled="multiple"
              @click="handleDelete"
              v-hasPermi="['communityUnit:community_child:remove']"
              >删除</el-button
            >
 ...
 <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          >
            <template slot-scope="scope">
              <el-button
                ...
                v-hasPermi="['communityUnit:community_building:query']"
                >楼栋列表</el-button
              >
              <el-button
                size="mini"
                ...
                v-hasPermi="['communityUnit:community_child:edit']"
                >修改</el-button
              >
              <el-button
                size="mini"
    ...
    <el-tab-pane label="网格管理" name="second">
       <el-table
          v-loading="loading"
          stripe
          :height="dataHeight"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="小区类型" prop="type">
          <el-select v-model="form.type" placeholder="请选择小区类型">
            <el-option
              v-for="dict in typeOptions"
              :key="dict.dictValue"
              :label="dict.dictLabel"
        ...
        <el-form-item label="楼宇数量" prop="buildingNum">
          <el-input v-model="form.buildingNum" placeholder="请输入楼宇数量" />
        </el-form-item>
        <el-form-item label="房屋数量" prop="houseNum">
          <el-input v-model="form.houseNum" placeholder="请输入房屋数量" />
        </el-form-item>
        ...
        <el-form-item label="行政区划" prop="code">
          <el-input v-model="form.code" placeholder="请输入行政区划" />
        </el-form-item>
        <el-form-item label="社区管理单位" prop="deptId">
          <el-select
            v-model="form.deptId"
            placeholder="请选择管理单位"
            clearable
          ...
          >
            <el-option
              v-for="dict in communityDeptOptions"
              :key="dict.dictValue"
              :label="dict.dictLabel"
              :value="dict.dictValue"
            />
        ...
        <el-form-item label="开始建设时间" prop="buildTime">
          <el-date-picker
            clearable
            size="small"
            style="width: 200px"
        ...
        <el-form-item label="竣工时间" prop="buildEndTime">
          <el-date-picker
            clearable
            size="small"
            style="width: 200px"
        ...
        <el-form-item label="建设单位" prop="buildUnit">
          <el-input v-model="form.buildUnit" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="施工单位" prop="constructionUnit">
          <el-input v-model="form.constructionUnit" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="监理单位" prop="supervisionUnit">
          <el-input v-model="form.supervisionUnit" placeholder="请输入内容" />
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="otherSubmitForm" v-if="form.id && form.id.length > 0"
          >另存一条</el-button
        >
    ...
    >
      ...
      >
        <el-form-item label="社区名称" prop="name">
          <el-input
            v-model="form_community.name"
            placeholder="请输入社区名称"
          />
        </el-form-item>
        <el-form-item label="社区地址">
          <v-distpicker
            :province.sync="form_community.addressProvincial"
            :city.sync="form_community.addressCitie"
            :area.sync="form_community.addressCountie"
            :code.sync="form_community.code"
          ></v-distpicker>
        </el-form-item>
        <el-form-item label="行政区划" prop="code">
          <el-input
            v-model="form_community.code"
            placeholder="请输入行政区划"
          />
        </el-form-item>
        <el-form-item label="街道" prop="untitled">
          <el-input
            v-model="form_community.untitled"
            placeholder="请输入街道"
          />
        </el-form-item>
        <el-form-item label="社区管理单位" prop="untitled">
          <el-tree
            :data="deptOptions"
            show-checkbox
            default-expand-all
        ...
        <el-form-item label="经度" prop="longitud">
          <el-input
            v-model="form_community.longitud"
            placeholder="请输入经度"
          />
        </el-form-item>
        <el-form-item label="纬度" prop="latitude">
          <el-input
            v-model="form_community.latitude"
            placeholder="请输入纬度"
          />
        </el-form-item>
        <el-form-item label="备注" prop="remark">
          <el-input
            v-model="form_community.remark"
            type="textarea"
            placeholder="请输入内容"
          />
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitForm_community"
          >确 定</el-button
        >
        <el-button @click="cancel">取 消</el-button>
      </div>
...
import {
  ...
  delCommunity_child,
  addCommunity_child,
  updateCommunity_child,
  exportCommunity_child
} from "@/api/communityUnit/community_child";
...
import {
  ...
  updateCommunity,
  exportCommunity
} from "@/api/communityUnit/community";
import {
  ...
  methods: {
    ...
    getDeptTreeselect() {
      deptTreeselect().then(response => {
        ...
        console.log(this.deptOptions, 909090);
      });
    },
    /** 根据角色ID查询部门树结构 */
    ...
    getTreeList() {
      ...
      //   console.log(this.treeOptions,808080);
      // });
      listDept().then(response => {
        if (response.code === 200) {
          this.treeOptions = this.handleTree(response.data);
        }
      });
    },
    // 筛选节点
      ...
      this.$refs["form_community"].validate(valid => {
        if (valid) {
          if (self.form_community.id != null) {
            self.form_community.deptIds = self.$cf.getStringFromList(
              self.getDeptAllCheckedKeys()
            );
    ...
    handleUpdate_community() {
      ...
      getCommunity(id).then(response => {
        ...
        self.$nextTick(function() {
          self.checkDeptIdList = self.$cf.getListFromString(
            self.form_community.deptIds
          );
