  ...
  <div class="carSearch">
    ...
    <div class="carSearchList">
      ...
      >
        ...
        <el-table-column prop="plate" align="center" label="车牌号">
        </el-table-column>
        <el-table-column prop="buildingName" align="center" label="楼栋">
        </el-table-column>
        <el-table-column prop="name" align="center" label="车主姓名">
        </el-table-column>
      </el-table>
    </div>
    <!--详情对话框-->
    ...
    >
      <div class="dialog_title">
        ...
        <el-col :span="1"
          ><span @click="open = false">{{ "×" }}</span></el-col
        >
      </div>
      <div style="width: 100%; height: 100%">
        <el-col :span="10">
          <div class="dialogCarClass_pic">
            <img style="width: 94%; height: 92%; margin: 3%" :src="picUrl" />
          </div>
        </el-col>
        <el-col :span="13">
            ...
            <el-row class="dialogCarClass_info_1">
              <el-form ref="form" :model="form" label-width="90px">
                <div class="el_form_itemDiv">
                  ...
                  <el-form-item label="颜色:" prop="zipinpai">
                    <span class="addr">{{ form.color || "暂无" }}</span>
                  </el-form-item>
                </div>
                <div class="el_form_itemDiv">
                  <el-form-item label="车位号:" prop="pinpai">
                    <span class="addr">{{
                      form.parkingSpaceNum || "暂无"
                    }}</span>
                  </el-form-item>
                  <el-form-item label="所属网格:" prop="carType">
...
export default {
  data() {
    return {
      content_background_image: {
        backgroundImage:
          "url(" + require("../../../assets/images/car/content.png") + ")",
  ...
  methods: {
    ...
    nameFormat(row, column, cellValue) {
      ...
      if (items && items.length > 0) {
        items.forEach((item) => {
          ...
          if (nameList && nameList.length) result += nameList[1] + ",";
        });
      }
      return result.trim(",");
    },
    ...
    getbotlistApi() {
      ...
      getBottomlist(communityId, communityChildId, this.queryparams).then(
        (res) => {
