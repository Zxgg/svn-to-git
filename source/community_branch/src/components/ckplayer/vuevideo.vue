...
export default {
  ...
  // },
    ...
    $('#OneScreenVideo' + self.videoPlayId).click(function (event) {
      $('#videoPlayerBody' + self.videoPlayId).addClass('videoPlayDivActive')
      $('#videoPlayerBody' + self.videoPlayId).parents('#RealTimeVideoPlayView_VideoDiv_Border').siblings().children('.videoPlay').children().removeClass('videoPlayDivActive')
    })
  ...
  methods: {
    ...
    initPlayer (url) {
      ...
      if (flvjs.isSupported()) {
        var videoElement = document.getElementById('videoPlayer' + this.videoPlayId)
