...
import { deviceClusterStyle, alarmClusterStyle, carClusterStyle, doorClusterStyle, faceClusterStyle, createOneStyle } from '@/components/gismap/mapfunction/vectorStyle'
const cluster = {
  data () {
    return {
      cameraSource: null,
      ...
      vehicleSource: null,
      vehicleLayer: null,
      gridMemberSource:null,
      gridMemberLayer:null
    }
  },
  mounted () {
    this.cluster()
  ...
  methods: {
    cluster () {
      ...
      me.cameraSource = new VectorSource()
      me.cameraLayer = new VectorLayer({
        name: 'camera',
        source: me.cameraSource,
        style: createOneStyle
      })
      me.map.addLayer(me.cameraLayer)//摄像机图层
      ...
      me.gridMemberSource = new VectorSource()
      me.gridMemberLayer = new VectorLayer({
        name: 'gridMember',
        source: me.gridMemberSource,
        style: createOneStyle
      })
      me.map.addLayer(me.gridMemberLayer)//网格员图层
    },
  }
}
