  ...
  <div class="app-container">
    <el-form :model="queryParams"
      ...
      <el-form-item label="组织名称"
        ...
        <el-input v-model="queryParams.organizationName"
                  placeholder="请输入组织名称"
                  clearable
                  size="small"
      ...
      <el-form-item label="组织类别"
        ...
        <el-select v-model="queryParams.organizationType"
                   placeholder="请选择境外非政府组织类别"
                   clearable
                   size="small">
          <el-option v-for="dict in organizationTypeOptions"
                     :key="dict.dictValue"
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="组织名称"
                       align="center"
                       prop="organizationName" />
      <el-table-column label="境外非政府组织类别"
                       align="center"
                       prop="organizationType"
    ...
    <el-dialog :title="title"
      ...
      <el-form ref="form"
        ...
        <el-form-item label="涉及领域"
                      prop="involveField">
          <el-input v-model="form.involveField"
                    placeholder="请输入涉及领域" />
        </el-form-item>
        <el-form-item label="主要联系人"
                      prop="mainLink">
          <el-input v-model="form.mainLink"
                    placeholder="请输入主要联系人" />
        </el-form-item>
        <el-form-item label="性别"
                      prop="sex">
...
<script>
import { listGroup_abroad, getGroup_abroad, delGroup_abroad, addGroup_abroad, updateGroup_abroad, exportGroup_abroad } from "@/api/communityManage/group_abroad";
...
export default {
  ...
  methods: {
    ...
    organizationTypeFormat (row, column) {
      return this.selectDictLabel(this.organizationTypeOptions, row.organizationType);
    },
    // 性别字典翻译
    ...
    handleDelete (row) {
      ...
      this.$confirm('是否确认删除境内外非政府组织编号为"' + ids + '"的数据项?', "警告", {
