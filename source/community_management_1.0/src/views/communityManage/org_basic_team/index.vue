      ...
      <el-form ref="form"
        ...
        <el-form-item label="级别"
          ...
          <!-- <el-input v-model="form.positionLevel"
                    placeholder="请输入级别" /> -->
          <el-select v-model="form.positionLevel"
                     placeholder="请选择职务">
            <el-option v-for="dict in positionLevelOptions"
                       :key="dict.dictValue"
                       :label="dict.dictLabel"
                       :value="dict.dictValue"></el-option>
          </el-select>
        ...
        <el-form-item label="职务"
          ...
          <el-select v-model="form.position"
                     placeholder="请选择职务">
            <el-option v-for="dict in positionOptions"
                       :key="dict.dictValue"
                       :label="dict.dictLabel"
                       :value="dict.dictValue"></el-option>
          </el-select>
...
<script>
import { listOrg_basic_team, getOrg_basic_team, delOrg_basic_team, addOrg_basic_team, updateOrg_basic_team, exportOrg_basic_team } from "@/api/communityManage/org_basic_team";
...
export default {
  ...
  methods: {
    ...
    handleDelete (row) {
      ...
      this.$confirm('是否确认删除综治队伍编号为"' + ids + '"的数据项?', "警告", {
