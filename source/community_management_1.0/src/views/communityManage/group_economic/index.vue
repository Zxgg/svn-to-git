  ...
  <div class="app-container">
    <el-form :model="queryParams"
      ...
      <el-form-item label="企业名称"
                    prop="businessName">
        <el-input v-model="queryParams.businessName"
                  placeholder="请输入企业名称"
                  clearable
                  size="small"
      ...
      <el-form-item label="工商执照号码"
                    prop="socialCode">
        <el-input v-model="queryParams.socialCode"
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="企业地址"
                       align="center"
                       prop="address" />
      <el-table-column label="企业联系方式"
                       align="center"
                       prop="tel" />
      <!-- <el-table-column label="企业员工数"
                       align="center"
                       prop="count" /> -->
      <el-table-column label="工商执照号码"
                       align="center"
                       prop="socialCode" />
      ...
      <el-table-column label="法人姓名"
                       align="center"
                       prop="legalName" />
      <el-table-column label="法人联系方式"
                       align="center"
                       prop="legalTel" />
      <el-table-column label="治保负责人姓名"
                       align="center"
                       prop="chargePersonName" />
      <el-table-column label="治保负责人联系方式"
                       align="center"
                       prop="chargePersonTel" />
      <el-table-column label="是否危化企业"
                       align="center"
                       prop="isDanger"
                       :formatter="isDangerFormat" />
      <el-table-column label="安全隐患类型"
                       align="center"
                       prop="dangerType"
    ...
    <el-dialog :title="title"
      ...
      <el-form ref="form"
        ...
        <el-form-item label="工商执照号码(统一社会信用代码)"
                      prop="socialCode">
        ...
        <el-form-item label="法人证件类型"
                      prop="legalType">
          <el-select v-model="form.legalType"
                     placeholder="请选择法人证件类型">
            <el-option v-for="dict in legalTypeOptions"
                       :key="dict.dictValue"
                       :label="dict.dictLabel"
        ...
        <el-form-item label="治保负责人姓名"
                      prop="chargePersonName">
          <el-input v-model="form.chargePersonName"
                    placeholder="请输入治保负责人姓名" />
        </el-form-item>
        <el-form-item label="治保负责人联系方式"
                      prop="chargePersonTel">
          <el-input v-model="form.chargePersonTel"
                    placeholder="请输入治保负责人联系方式" />
        </el-form-item>
        <el-form-item label="是否危化企业"
                      prop="isDanger">
          <el-select v-model="form.isDanger"
                     placeholder="请选择是否危化企业">
            <el-option v-for="dict in isDangerOptions"
                       :key="dict.dictValue"
                       :label="dict.dictLabel"
        ...
        <el-form-item label="关注程度"
                      prop="isFocus">
          <el-select v-model="form.isFocus"
                     placeholder="请选择关注程度">
            <el-option v-for="dict in isFocusOptions"
                       :key="dict.dictValue"
                       :label="dict.dictLabel"
        ...
        <el-form-item label="是否具备建立党组织条件"
                      prop="isPartyConditions">
          <el-select v-model="form.isPartyConditions"
                     placeholder="请选择是否具备建立党组织条件">
            <el-option v-for="dict in isPartyConditionsOptions"
                       :key="dict.dictValue"
                       :label="dict.dictLabel"
        ...
        <el-form-item label="是否有党组织"
                      prop="isParty">
          <el-select v-model="form.isParty"
                     placeholder="请选择是否有党组织">
            <el-option v-for="dict in isPartyOptions"
                       :key="dict.dictValue"
                       :label="dict.dictLabel"
        ...
        <el-form-item label="党员数量"
                      prop="partyMemberCount">
          <el-input v-model="form.partyMemberCount"
                    placeholder="请输入党员数量" />
        </el-form-item>
        <el-form-item label="是否有工会"
                      prop="isUnion">
          <el-select v-model="form.isUnion"
                     placeholder="请选择是否有工会">
            <el-option v-for="dict in isUnionOptions"
                       :key="dict.dictValue"
                       :label="dict.dictLabel"
        ...
        <el-form-item label="工会会员数量"
                      prop="unionMemberCount">
          <el-input v-model="form.unionMemberCount"
                    placeholder="请输入工会会员数量" />
        </el-form-item>
        <el-form-item label="是否有共青团组织"
                      prop="isCommunist">
          <el-select v-model="form.isCommunist"
                     placeholder="请选择是否有共青团组织">
            <el-option v-for="dict in isCommunistOptions"
                       :key="dict.dictValue"
                       :label="dict.dictLabel"
        ...
        <el-form-item label="共青团团员数量"
                      prop="communistMemberCount">
          <el-input v-model="form.communistMemberCount"
                    placeholder="请输入共青团团员数量" />
        </el-form-item>
        <el-form-item label="是否有妇联组织"
                      prop="isWomenFed">
          <el-select v-model="form.isWomenFed"
                     placeholder="请选择是否有妇联组织">
            <el-option v-for="dict in isWomenFedOptions"
                       :key="dict.dictValue"
                       :label="dict.dictLabel"
        ...
        <el-form-item label="妇联组织成员数量"
                      prop="womenFedCount">
          <el-input v-model="form.womenFedCount"
                    placeholder="请输入妇联组织成员数量" />
        </el-form-item>
        <el-form-item label="经度"
                      prop="longitudes">
          <el-input v-model="form.longitudes"
                    placeholder="请输入经度" />
        </el-form-item>
        <el-form-item label="纬度"
                      prop="latitudes">
          <el-input v-model="form.latitudes"
                    placeholder="请输入纬度" />
        </el-form-item>
      </el-form>
      <div slot="footer"
...
<script>
import { listGroup_economic, getGroup_economic, delGroup_economic, addGroup_economic, updateGroup_economic, exportGroup_economic } from "@/api/communityManage/group_economic";
...
export default {
  ...
  methods: {
    ...
    isPartyConditionsFormat (row, column) {
      return this.selectDictLabel(this.isPartyConditionsOptions, row.isPartyConditions);
    },
    // 是否有党组织字典翻译
    ...
    handleDelete (row) {
      ...
      this.$confirm('是否确认删除非公经济组织信息编号为"' + ids + '"的数据项?', "警告", {
